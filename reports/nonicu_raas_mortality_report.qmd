...
![](../assets/nonicu_table_lineage_construction.svg){fig-alt="MIMIC-IV source tables to project-created non-ICU cohort, exposure, and analysis dataset tables" width="95%"}
